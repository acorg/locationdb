...
PYBIND11_MODULE(locationdb_backend, m)
{
    ...
    m.def("get_locdb", [](bool suppress_error, bool aTimer) { return get_locdb(suppress_error ? locdb_suppress_error::yes : locdb_suppress_error::no, do_report_time(aTimer)); },
